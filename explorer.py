...
print("=== Choisis une zone à découvrir ===")
print(f"1 - {zones_affichees[0]}")
print(f"2 - {zones_affichees[1]}")
print(f"3 - {zones_affichees[2]}")

choix = input("Entre 1, 2 ou 3 : ")

if choix == "1":
    zone_choisie = zones_affichees[0]
elif choix == "2":
    zone_choisie = zones_affichees[1]
elif choix == "3":
    zone_choisie = zones_affichees[2]
else:
...
print("\n===================================")
print(couleur + f"Vous avez choisi de visiter la zone : {zone_choisie}" + RESET)
print(couleur + descriptions[zone_choisie] + RESET)
print("===================================\n")

print("Trois coffres antiques apparaissent devant toi...\n")

print("1 - Coffre ancien")
print("2 - Coffre mystérieux")
print("3 - Coffre doré")

choix_coffre = input("Choisis un coffre (1, 2 ou 3) : ")

if choix_coffre in ["1", "2", "3"]:
    print("\nTu ouvres lentement le coffre...")
    print("[loot aléatoire]")
else:
    print("Choix invalide.")